...
hi Constant guifg=#c8adc0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi CursorColumn guifg=NONE guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Cursor guifg=#222222 guibg=#b36d43 guisp=NONE blend=NONE gui=NONE
hi CursorLine guifg=NONE guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi CursorLineNr guifg=#8da1b9 guibg=#1c1c1c guisp=NONE blend=NONE gui=bold
hi Delimiter guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticDeprecated guifg=NONE guibg=NONE guisp=#b36d43 blend=NONE gui=strikethrough
hi DiagnosticError guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticHintFloating guifg=#8da1b9 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticHint guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticInfo guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticOk guifg=#8da1b9 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignError guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignHint guifg=#78824b guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignInfo guifg=#8da1b9 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiagnosticSignWarn guifg=#b36d43 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticVirtualTextError guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextHint guifg=#8da1b9 guibg=#222222 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextInfo guifg=#8da1b9 guibg=#222222 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarn guifg=#b36d43 guibg=#222222 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarning guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarn guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarningFloating guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarning guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiffAdded guifg=#78824b guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiffAdd guifg=#222222 guibg=#78824b guisp=NONE blend=NONE gui=NONE
hi DiffChange guifg=#222222 guibg=#b36d43 guisp=NONE blend=NONE gui=NONE
hi DiffDelete guifg=#222222 guibg=#c9a554 guisp=NONE blend=NONE gui=bold
hi DiffRemoved guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiffText guifg=#222222 guibg=#c2c2b0 guisp=NONE blend=NONE gui=bold
hi Directory guifg=#8da1b9 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Error guifg=#c2c2b0 guibg=#c8adc0 guisp=NONE blend=NONE gui=NONE
hi ErrorMsg guifg=#c9a554 guibg=#222222 guisp=NONE blend=NONE gui=NONE
...
hi Folded guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Function guifg=#78834b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitBranch guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitSelectedFile guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitSelectedType guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitUnmergedFile guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitUnmergedType guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi GitSignsAdd guifg=#78824b guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi GitSignsChange guifg=#b36d43 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi GitSignsDelete guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi htmlArg guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi htmlTag guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi htmlTagName guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi IncSearch guifg=#222222 guibg=#c8adc0 guisp=NONE blend=NONE gui=NONE
hi Keyword guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi LazySpecial guifg=#c2c2b0 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi lessVariable guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi LspBorderBG guifg=#b36d43 guibg=#222222 guisp=NONE blend=NONE gui=NONE
hi LspFloatWinNormal guifg=#d7c483 guibg=#43492a guisp=NONE blend=NONE gui=NONE
hi LspReferenceRead guifg=#78824b guibg=NONE guisp=#fd9720 blend=NONE gui=bold,undercurl
hi LspReferenceText guifg=#d7c483 guibg=#43492a guisp=#fd9720 blend=NONE gui=bold,undercurl
hi LspReferenceWrite guifg=#78824b guibg=NONE guisp=#fd9720 blend=NONE gui=bold,undercurl
...
hi MasonHighlight guifg=#8da1b9 guibg=#222222 guisp=NONE blend=NONE gui=NONE
hi MasonHighlightSecondary guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=NONE
hi MasonMuted guifg=#c2c2b0 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi MoreMsg guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=bold
hi mustacheMarker guifg=#c8adc0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi mustachePartial guifg=#c8adc0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi mustacheSection guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=bold
hi mustacheVariable guifg=#c2c2b0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi mustacheVariableUnescape guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi netrwClassify guifg=#666666 guibg=NONE guisp=NONE blend=NONE gui=bold
hi netrwExe guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi Number guifg=#8da1b9 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi NvimInternalError guifg=#1c1c1c guibg=#c9a554 guisp=NONE blend=NONE gui=NONE
hi phpIdentifier guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi phpSpecialFunction guifg=#c8adc0 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi Question guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=bold
hi RedrawDebugClear guifg=#222222 guibg=#c2c2b0 guisp=NONE blend=NONE gui=NONE
...
hi RedrawDebugRecompose guifg=#222222 guibg=#c8adc0 guisp=NONE blend=NONE gui=NONE
...
hi ScrollbarError guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarErrorHandle guifg=#b36d43 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarGitAdd guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitAddHandle guifg=#78824b guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarGitChange guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitChangeHandle guifg=#b36d43 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarGitDelete guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitDeleteHandle guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarHandle guifg=NONE guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarHint guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarHintHandle guifg=#78824b guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarInfo guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarInfoHandle guifg=#78824b guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarMisc guifg=#c8adc0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarMiscHandle guifg=#c8adc0 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarSearch guifg=#c2c2b0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarSearchHandle guifg=#c2c2b0 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarWarn guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarWarnHandle guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi Search guifg=#222222 guibg=#78824b guisp=NONE blend=NONE gui=NONE
hi shDerefSimple guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SignColumn guifg=#666666 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Special guifg=#c8adc0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SpecialKey guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SpellBad guifg=#b36d43 guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi SpellCap guifg=#78824b guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi SpellLocal guifg=#c8adc0 guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi SpellRare guifg=#c9a554 guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi Statement guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=bold
...
hi String guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SyntasticErrorSign guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SyntasticWarningSign guifg=#b36d43 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi TabLineFill guifg=#c2c2b0 guibg=#222222 guisp=NONE blend=NONE gui=NONE
...
hi TelescopeBorder guifg=#b36d43 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi TelescopePromptBorder guifg=#c9a554 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi TelescopeSelectionCaret guifg=#d7c483 guibg=#8da1b9 guisp=NONE blend=NONE gui=NONE
hi TelescopeTitle guifg=#78824b guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi TermCursor guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=reverse
hi Title guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=bold
...
hi User1 guifg=#d7c483 guibg=#c8adc0 guisp=NONE blend=NONE gui=NONE
hi User2 guifg=#d7c483 guibg=#666666 guisp=NONE blend=NONE gui=NONE
hi User3 guifg=#d7c483 guibg=#c9a554 guisp=NONE blend=NONE gui=NONE
hi User4 guifg=#d7c483 guibg=#222222 guisp=NONE blend=NONE gui=NONE
hi User5 guifg=#d7c483 guibg=#c8adc0 guisp=NONE blend=NONE gui=NONE
hi User6 guifg=#d7c483 guibg=#c2c2b0 guisp=NONE blend=NONE gui=NONE
hi User7 guifg=#d7c483 guibg=#8da1b9 guisp=NONE blend=NONE gui=NONE
hi User8 guifg=#d7c483 guibg=#c9a554 guisp=NONE blend=NONE gui=NONE
...
hi Visual guifg=#222222 guibg=#8da1b9 guisp=NONE blend=NONE gui=NONE
hi WarningMsg guifg=#c9a554 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi WhichKeyBorder guifg=NONE guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi WhichKeyDesc guifg=#78824b guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi WhichKeySeparator guifg=#c2c2b0 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi WhichKeyValue guifg=#c2c2b0 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi WildMenu guifg=black guibg=#c2c2b0 guisp=NONE blend=NONE gui=NONE
hi WinBar guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=bold
hi xmlTag guifg=#8da1b9 guibg=NONE guisp=NONE blend=NONE gui=NONE
